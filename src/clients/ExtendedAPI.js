...
class ExtendedAPI extends JSONRPC.Client
{
	 ...
	 async container_platform_monitoring_data_get(nContainerPlatformID, nGranularityMinutes = 1, strTimestampStart = null, strTimestampEnd = null)
	{
	 ...
	 async license_type_for_volume_template(strVolumeTemplateID)
	{
		return await this.rpc("license_type_for_volume_template", Array.prototype.slice.call(arguments));
	}
	 ...
	 async data_lake_core_site_conf_download_url(strUserID, nDataLakeID)
	{
	 ...
	 async secure_gateway_authorize_resource(strResourceUrl)
	{
		return await this.rpc("secure_gateway_authorize_resource", Array.prototype.slice.call(arguments));
	}
