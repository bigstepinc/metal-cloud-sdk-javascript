...
class ExtendedAPI extends JSONRPC.Client
{
	...
	async infrastructure_gui_settings_save(strInfrastructureID, objGUIProductSettings, arrPropertyNames)
	{
		return await this.rpc("infrastructure_gui_settings_save", Array.prototype.slice.call(arguments));
	}
	...
	async user_gui_settings_save(strUserID, objGUIUserSettings, arrPropertyNames)
	{
		return await this.rpc("user_gui_settings_save", Array.prototype.slice.call(arguments));
	}
	...
	async cluster_gui_settings_save(strClusterID, objGUIProductSettings, arrPropertyNames)
	{
		return await this.rpc("cluster_gui_settings_save", Array.prototype.slice.call(arguments));
	}

	async event_counters(strInfrastructureID)
	{
		return await this.rpc("event_counters", Array.prototype.slice.call(arguments));
	}
	...
	async infrastructure_hang_until_touched(nInfrastructureID, strKnownValue)
	{
		return await this.rpc("infrastructure_hang_until_touched", Array.prototype.slice.call(arguments));
	}

	async instance_interface_ips(nInstanceInterfaceID)
	{
		return await this.rpc("instance_interface_ips", Array.prototype.slice.call(arguments));
	}
	...
	async instance_array_gui_settings_save(strInstanceArrayID, objGUIProductSettings, arrPropertyNames)
	{
		return await this.rpc("instance_array_gui_settings_save", Array.prototype.slice.call(arguments));
	}
	...
	async data_lake_gui_settings_save(strDataLakeID, objGUIProductSettings, arrPropertyNames)
	{
		return await this.rpc("data_lake_gui_settings_save", Array.prototype.slice.call(arguments));
	}

	async monitoring_instance_measurement_value_get(nInstanceMeasurementID)
	{
		return await this.rpc("monitoring_instance_measurement_value_get", Array.prototype.slice.call(arguments));
	}

	async monitoring_instance_measurements_get_for_instance(strInstanceID, bIgnoreVirtualEthernetInterfaces = false)
	{
		return await this.rpc("monitoring_instance_measurements_get_for_instance", Array.prototype.slice.call(arguments));
	}

	async monitoring_instance_measurements_rendering_get(strInstanceID, arrMeasurements, objRenderingOptions = [], bEncodeBase64 = true)
	{
		return await this.rpc("monitoring_instance_measurements_rendering_get", Array.prototype.slice.call(arguments));
	}

	async monitoring_instance_interface_measurements_rendering_get(nInstanceInterfaceID, arrMeasurements, objRenderingOptions = [], bEncodeBase64 = true)
	{
		return await this.rpc("monitoring_instance_interface_measurements_rendering_get", Array.prototype.slice.call(arguments));
	}

	async monitoring_network_measurements_rendering_get(strNetworkID, strNetworkTrafficType, arrMeasurements, objRenderingOptions = [], bEncodeBase64 = true)
	{
		return await this.rpc("monitoring_network_measurements_rendering_get", Array.prototype.slice.call(arguments));
	}
	...
	async network_gui_settings_save(strNetworkID, objGUIProductSettings, arrPropertyNames)
	{
		return await this.rpc("network_gui_settings_save", Array.prototype.slice.call(arguments));
	}
	...
	async server_type_available_server_count(strUserIDOwner, strDatacenterName, strServerTypeID, nMaximumResults)
	{
		return await this.rpc("server_type_available_server_count", Array.prototype.slice.call(arguments));
	}
	...
	async shared_drive_gui_settings_save(strSharedDriveID, objGUIProductSettings, arrPropertyNames)
	{
		return await this.rpc("shared_drive_gui_settings_save", Array.prototype.slice.call(arguments));
	}
	...
	async drive_array_gui_settings_save(strDriveArrayID, objGUIProductSettings, arrPropertyNames)
	{
		return await this.rpc("drive_array_gui_settings_save", Array.prototype.slice.call(arguments));
	}
	...
	async transport_request_public_key(bGenerateNewIfNotFound = true)
	{
		return await this.rpc("transport_request_public_key", Array.prototype.slice.call(arguments));
	}

	async user_email_to_user_id(strLoginEmail)
	{
		return await this.rpc("user_email_to_user_id", Array.prototype.slice.call(arguments));
	}
	...
	async container_array_gui_settings_save(strContainerArrayID, objGUIProductSettings, arrPropertyNames)
	{
		return await this.rpc("container_array_gui_settings_save", Array.prototype.slice.call(arguments));
	}

	async container_platform_gui_settings_save(strContainerPlatformID, objGUIProductSettings, arrPropertyNames)
	{
		return await this.rpc("container_platform_gui_settings_save", Array.prototype.slice.call(arguments));
	}
	...
	async resource_utilization_summary_start_timestamp_default(strUserID)
	{
		return await this.rpc("resource_utilization_summary_start_timestamp_default", Array.prototype.slice.call(arguments));
	}
	...
	async infrastructure_public_designs()
	{
		return await this.rpc("infrastructure_public_designs", Array.prototype.slice.call(arguments));
	}

	async server_type_available_server_count_batch(strUserIDOwner, strDatacenterName, arrServerTypeIDs, nMaximumResults, bIncludeReservedForUser = false, nInstanceArrayID = null)
	{
		return await this.rpc("server_type_available_server_count_batch", Array.prototype.slice.call(arguments));
	}
	...
	async subnet_create_from_owned_subnet_pool(strNetworkID, objSubnet)
	{
		return await this.rpc("subnet_create_from_owned_subnet_pool", Array.prototype.slice.call(arguments));
	}
	...
	async container_cluster_gui_settings_save(strContainerClusterID, objGUIProductSettings, arrPropertyNames)
	{
		return await this.rpc("container_cluster_gui_settings_save", Array.prototype.slice.call(arguments));
	}
	...
	async instance_monitoring_data_get(nInstanceID, nGranularityMinutes = 1, strTimestampStart = null, strTimestampEnd = null)
	{
		return await this.rpc("instance_monitoring_data_get", Array.prototype.slice.call(arguments));
	}

	async instance_array_monitoring_data_get(nInstanceArrayID, nGranularityMinutes = 1, strTimestampStart = null, strTimestampEnd = null)
	{
		return await this.rpc("instance_array_monitoring_data_get", Array.prototype.slice.call(arguments));
	}

	async container_platform_monitoring_data_get(nContainerPlatformID, nGranularityMinutes = 1, strTimestampStart = null, strTimestampEnd = null)
	{
		return await this.rpc("container_platform_monitoring_data_get", Array.prototype.slice.call(arguments));
	}
	...
	async infrastructure_tags_add(strInfrastructureID, arrInfrastructureTagsNames)
	{
		return await this.rpc("infrastructure_tags_add", Array.prototype.slice.call(arguments));
	}

	async infrastructure_tags_set(strInfrastructureID, arrInfrastructureTagsNames)
	{
		return await this.rpc("infrastructure_tags_set", Array.prototype.slice.call(arguments));
	}

	async infrastructure_tags(strInfrastructureID)
	{
		return await this.rpc("infrastructure_tags", Array.prototype.slice.call(arguments));
	}

	async infrastructure_tags_remove(strInfrastructureID, arrInfrastructureTagsNames)
	{
		return await this.rpc("infrastructure_tags_remove", Array.prototype.slice.call(arguments));
	}
	...
	async instance_tags_add(strInstanceID, arrInstanceTagsNames)
	{
		return await this.rpc("instance_tags_add", Array.prototype.slice.call(arguments));
	}

	async instance_tags_set(strInstanceID, arrInstanceTagsNames)
	{
		return await this.rpc("instance_tags_set", Array.prototype.slice.call(arguments));
	}

	async instance_tags(strInstanceID)
	{
		return await this.rpc("instance_tags", Array.prototype.slice.call(arguments));
	}

	async instance_tags_remove(strInstanceID, arrInstanceTagsNames)
	{
		return await this.rpc("instance_tags_remove", Array.prototype.slice.call(arguments));
	}
	...
	async query_agent_for_metric_datapoints_multidc(strTarget, strFrom, strFormat = null, strUntil = null, bIncludeMetadata = false)
	{
		return await this.rpc("query_agent_for_metric_datapoints_multidc", Array.prototype.slice.call(arguments));
	}
	...
	async os_template_network_create(strUserID, strNewOSTemplateLabel, strDescription, strOSTemplateDisplayName, objNetworkOperatingSystem, arrOSTemplateTags = [], strOSTemplateVersion = "0.0.0")
	{
		return await this.rpc("os_template_network_create", Array.prototype.slice.call(arguments));
	}
	...
	async instance_monitoring_paths_get(nInstanceID, bRelativePaths)
	{
		return await this.rpc("instance_monitoring_paths_get", Array.prototype.slice.call(arguments));
	}

	async instance_monitoring_paths_get_structured(nInstanceID, bRelativePaths)
	{
		return await this.rpc("instance_monitoring_paths_get_structured", Array.prototype.slice.call(arguments));
	}

	async monitoring_agent_all_query_paths_get_structured(strDatacenterName)
	{
		return await this.rpc("monitoring_agent_all_query_paths_get_structured", Array.prototype.slice.call(arguments));
	}

	async monitoring_agent_all_query_paths_get(strDatacenterName)
	{
		return await this.rpc("monitoring_agent_all_query_paths_get", Array.prototype.slice.call(arguments));
	}

	async kubernetes_config(nInfrastructureID, objConnectionDetails)
	{
		return await this.rpc("kubernetes_config", Array.prototype.slice.call(arguments));
	}

	async kubernetes_token(nInfrastructureID, objConnectionDetails)
	{
		return await this.rpc("kubernetes_token", Array.prototype.slice.call(arguments));
	}

	async table_column_name_to_information(strTableName)
	{
		return await this.rpc("table_column_name_to_information", Array.prototype.slice.call(arguments));
	}

	async volume_template_create_from_drive(strDriveID, objNewVolumeTemplate)
	{
		return await this.rpc("volume_template_create_from_drive", Array.prototype.slice.call(arguments));
	}
