...
class API extends JSONRPC.Client
{
	...
	// 204 functions available on endpoint.
	...
	server_type_reservations_expired_stop()
	{
		return this.rpc("server_type_reservations_expired_stop", Array.prototype.slice.call(arguments));
	}
