...
/**
 * Class representing the Guest Client.
 * @extends JSONRPC.Client
 */
module.exports =
class Guest extends JSONRPC.Client
{
	/**
	...
	async user_authenticate_guest()
	{
		return await this.rpc("user_authenticate_guest", Array.prototype.slice.call(arguments));
	}
