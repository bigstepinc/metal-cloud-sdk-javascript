	...
	_schemaDefinition()
	{
		return {
			...
			"properties": {
				...
				"os_template_use_autogenerated_initial_password": {
					"type": "boolean",
					"description": "Option to use the autogenerated password instead of the one provided in os_template_initial_password.",
					"default": false,
					"required": false
				},
