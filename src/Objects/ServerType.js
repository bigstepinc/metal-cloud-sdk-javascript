	...
	_schemaDefinition()
	{
		return {
			...
			"properties": {
				...
				"server_gpu_vendors_json": {
					"type": [
						"string",
						"null"
					],
					"description": "The vendors of the server GPUs.",
					"default": null
				},
				"server_gpu_models_json": {
					"type": [
						"string",
						"null"
					],
					"description": "The models of the server GPUs.",
					"default": null
				},
				"server_type_boot_type": {
					...
					"description": "The boot modes supported by servers of this type.",
					"default": "legacy_only"
				},
				"server_type_tags": {
					"type": "array",
