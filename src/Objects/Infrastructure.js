	...
	_schemaDefinition()
	{
		return {
			...
			"properties": {
				...
				"infrastructure_experimental_priority": {
					"enum": [
						"disallow",
						"avoid",
						"equal",
				...
				"infrastructure_is_automanaged": {
					"type": "boolean",
					"description": "Infrastructure holding independent instances.",
					"default": false,
					"readonly": true
				},
				"subnet_pool_lan": {
				...
				"infrastructure_description": {
					...
					"description": "Infrastructure description for supporting ProjectAPI feature.",
					"maxLength": 230,
					"required": false,
					"default": null
				}
