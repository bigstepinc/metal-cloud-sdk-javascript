		...
		return {
			...
			"properties": {
				...
				"volume_template_local_disk_supported": {
					"type": "boolean",
					"description": "Whether the template supports booting and running from local disks.",
					"default": false,
					"required": false
				},
				"volume_template_is_os_template": {
					"type": "boolean",
					"description": "Whether the template is an OS template.",
					"default": false,
					"required": false
				},
				...
				"volume_template_boot_type": {
					...
					"description": "The server needs to have the given boot type to use the volume template."
				},
				...
				"volume_template_server_types_whitelist": {
					"type": [
						"array",
						"null"
					],
					"description": "Server types that are compatible with this template. If null, no server types are filtered by this.",
					"required": false,
					"readonly": true,
					"default": null
				},
				...
				"volume_template_version": {
					"type": "string",
					"description": "The volume template version.",
					"default": "0.0.0",
					"required": false
				},
				"volume_template_variables_json": {
					"type": [
						"string",
						"null"
					],
					"description": "Custom variables definitions. Deserializes into an object of form <variable_name>:<variable_value>. In case of a variable name conflict, the variables defined here override the variables inherited from any context except an VolumeTemplate OSAsset association custom variable definition (volume_template_os_asset_variables_json).",
					"default": null,
					"readonly": false
				},
				"type": {
				...
				"volume_template_service_status": {
					"type": "string",
					"enum": [
						"active",
						"deleted"
					],
					"description": "The status of the volume template.",
					"default": "active"
				},
				"volume_template_created_from_drive_id": {
					"type": [
						"integer",
						"null",
						"string"
					],
					"description": "The id of the drive used to create the volume template.",
					"required": false,
					"default": null
				},
				"volume_template_os_bootstrap_function_name": {
					"type": [
						"string",
						"null"
					],
					"description": "OS bootstrap function name.",
					"required": false,
					"default": null
				},
				"volume_template_os_bootstrap_function_params": {
					...
					"description": "OS bootstrap function parameters.",
					"required": false,
					"default": [
				...
				"volume_template_is_experimental": {
					"type": "boolean",
					"description": "Whether the template is experimental.",
					"default": false,
					"required": false
				},
				"volume_template_os_local_disk_clone_function_name": {
					"type": [
						"string",
						"null"
					],
					"description": "Local disk clone function name.",
					"default": null,
					"required": false
				},
				"stage_definition_id_ansible_bundle_os_install": {
					"type": [
						"integer",
						"null"
					],
					"description": "Stage definition id for os install.",
					"default": null,
					"required": false
				},
				"stage_definition_id_ansible_bundle_os_boot_post_install": {
					"type": [
						"integer",
						"null"
					],
					"description": "Stage definition id for os boot post install .",
					"default": null,
					"required": false
				},
				"volume_template_is_for_switch": {
					"type": "boolean",
					"description": "Whether the template is for a switch.",
					"default": false,
					"required": false
				},
				"volume_template_network_operating_system": {
					"type": [
						"NetworkOperatingSystem",
						"null"
					],
					"description": "NetworkOperatingSystem",
					"default": null,
					"readonly": true,
					"required": false
				}
