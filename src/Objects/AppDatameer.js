...
module.exports = 
class AppDatameer extends ObjectBase
{
	/**
	 * @protected
	 * 
	...
	{
		return {
			"description": "An object which has instance labels as keys and <a:schema>AppDatameerInstance<\/a:schema> objects as values. <a:schema>AppDatameerInstance<\/a:schema> objects are divided into head nodes and data nodes.",
			"type": "object",
			"properties": {
				"datameer_nodes": {
					"type": "array",
					"items": {
						"type": "AppDatameerInstance",
						"description": ""
					},
					"description": "The <a:schema>AppDatameerInstance<\/a:schema> objects."
				},
				"admin_username": {
					"type": [
						"string",
