...
class AppMesos extends ObjectBase
{
	...
	{
		return {
			"description": "An object which has instance labels as keys and <a:schema>AppMesosInstance<\/a:schema> objects as values.",
			"type": "object",
			"properties": {
				"mesos_headnodes": {
					"type": "array",
					"items": {
						"type": "AppMesosInstance",
						"description": ""
					},
					"description": "The <a:schema>AppMesosInstance<\/a:schema> objects.",
					"required": true
				},
				"mesos_slavenodes": {
					"type": "array",
