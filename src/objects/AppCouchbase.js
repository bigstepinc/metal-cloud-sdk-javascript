...
/**
 * An object which has instance labels as keys and AppCouchbaseInstance objects
 * as values.
 *
 * @class
 * @extends ObjectBase
...
class AppCouchbase extends ObjectBase
{
	constructor(nodes)
	{
		...
		if(nodes === undefined || nodes === null)
			throw new Error("Invalid param in AppCouchbase constructor.");

		this._nodes = nodes;
	}

	/**
	 * The AppCouchbaseInstance objects.
	 */
	get nodes()
	{
