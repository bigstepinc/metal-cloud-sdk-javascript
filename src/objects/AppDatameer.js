...
/**
 * An object which has instance labels as keys and AppDatameerInstance objects
 * as values. AppDatameerInstance objects are divided into head nodes and data nodes.
 *
 * @class
 * @extends ObjectBase
 */
...
class AppDatameer extends ObjectBase
{
	...
	/**
	 * The AppDatameerInstance objects.
	 */
	get datameer_nodes()
	{
	...
	{
		this._datameer_nodes = datameer_nodes;
	}
