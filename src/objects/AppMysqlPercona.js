...
/**
 * An object which has instance labels as keys and AppMysqlPercona objects as values.
 *
 * @class
 * @extends ObjectBase
 */
...
class AppMysqlPercona extends ObjectBase
{
	constructor(nodes)
	{
		...
		if(nodes === undefined || nodes === null)
			throw new Error("Invalid param in AppMysqlPercona constructor.");

		this._nodes = nodes;
	}

	/**
	 * The AppMysqlPerconaInstance objects.
	 */
	get nodes()
	{
		return this._nodes || [];
