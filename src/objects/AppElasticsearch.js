...
class AppElasticsearch extends ObjectBase
{
	...
	{
		return {
			"description": "An object which has instance labels as keys and <a:schema>AppElasticsearchInstance<\/a:schema> objects as values.",
			"type": "object",
			"properties": {
				"nodes": {
					"type": "array",
					...
					"description": "The <a:schema>AppElasticsearchInstance<\/a:schema> objects, part of the nodes group.",
					"required": true
				},
