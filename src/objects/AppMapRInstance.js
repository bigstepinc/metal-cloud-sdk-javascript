...
class AppMapRInstance extends ObjectBase
{
	...
	{
		return {
			"description": "Details about the Instance object specific to MapR. The information presented here is obtained by interrogating the MapR API. Backward compatibility object will not be ensured when the underlying MapR API changes.",
			"type": "object",
			"properties": {
				"instance_id": {
					"type": [
