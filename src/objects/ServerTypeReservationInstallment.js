...
class ServerTypeReservationInstallment extends ObjectBase
{
	...
	{
		return {
			"description": "Represents a cyclical installment of a reservation created for a specific server type.",
			"type": "object",
			"properties": {
				...
				"server_type_reservation_installment_id": {
					"type": [
						"integer",
						"null"
					],
				...
				"type": {
					...
					"enum": [
						"ServerTypeReservationInstallment"
					],
					"readonly": true
				}
			}
